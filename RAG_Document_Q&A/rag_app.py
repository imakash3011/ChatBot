...
# create_retrieval chain is used interact with external data source
...
if st.button("Document Embedding"):
    # Running the above function and converting documents into vector
...
if user_prompt:
    ## create a chain to pass list of documents to model
