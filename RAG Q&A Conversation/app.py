## RAG Q&A Conversation with PDF including chat history (Working-fine)
...
os.environ['HF_TOEKN'] = os.getenv("HF_TOKEN")
...
if api_key:
    ...
    if uploaded_files:
        ...
        contextualize_q_system_prompt = (
            ...
            "formulate a standaline question which can be understood"
        ...
        def get_session_history(session:str)-> BaseChatMessageHistory:
            if session_id not in st.session_state.store:
                # Chat_history will get saved here
